...
# Inherit stock camera
$(call inherit-product, vendor/infinix/x610-transsioncamera/x610/x610-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/privapp-permissions-org.lineageos.infinix.imsinit.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-org.lineageos.infinix.imsinit.xml
